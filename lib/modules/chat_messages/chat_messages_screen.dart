                          ...
                          Container(
                            ...
                            child: MaterialButton(
                              onPressed: ()
                              {
                                ...
                                var formattedDate = DateFormat('d MMM yyyy h:mm a','en_US').format(fullDate);
                                ...
                                {
                                  SocialCubit.get(context).sendMessage(name: otherUser!.name,image: otherUser!.image,receiverUid: otherUser!.uId, message:chatController.text , dateTime: formattedDate.toString(),date:date,time: time ,fullDate: fullDate.toString());
